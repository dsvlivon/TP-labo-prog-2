...
namespace ClasePrincipal
{
    public class Negocio
    {
        ...
        /// <summary>
        /// sobrecarga del - para restar un producto a la lista, si este no estaba con anterioridad
        /// </summary>
        /// <param name="n"></param>
        /// <param name="p"></param>
        /// <returns> el objeto negocio modificado </returns>
        ...
        public void Vender(Producto producto, Cliente cliente, int cantidad)
        {
            if(producto != null && cantidad > 0)
            {
                Venta nuevaVenta = new Venta(producto, cliente,  cantidad);
        ...
        /// <summary>
        /// Metodo para anular y refrescar la venta en curso segun cliente
        /// </summary>
        public void LimpiarVentaPorCliente(Cliente cliente)
        {
        ...
        /// </summary>
        /// <returns> retorna un objeto sb 'stringBuilder' ToString() </returns>
        ...
        /// <summary>
        /// Metodo para listar los productos vendidos y calcular iva e importe total en base al neto
        /// </summary>
        /// <returns> retorna un objeto sb 'stringBuilder' ToString() </returns>
